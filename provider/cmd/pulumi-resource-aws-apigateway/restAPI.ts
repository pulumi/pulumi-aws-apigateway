...
import { createAPI } from "./apigateway/api";
...
export declare type IntegrationType =
  | "aws"
  | "aws_proxy"
  | "http"
  | "http_proxy"
  | "mock";
export declare type IntegrationPassthroughBehavior =
  | "when_no_match"
  | "when_no_templates"
  | "never";
...
export class RestAPI extends pulumi.ComponentResource {
  ...
  public readonly apiPolicy?: pulumi.Output<
    aws.apigateway.RestApiPolicy | undefined
  >;
